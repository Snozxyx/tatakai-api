...
async function runTests() {
    ...
    const tests = [
        ...
        // 5. CONSUMET (Aggregator)
        {
            ...
            url: "https://tatakaiapi.vercel.app/api/v1/consumet/anime/gogoanime/naruto",
            check: (data: any) => data.results && data.results.length > 0
        },
        // 6. DOCS (Static)
        {
            name: "Docs: UI Access",
            url: "https://tatakaiapi.vercel.app/docs",
            raw: true,
            check: (text: string) => text.includes("TATAKAI")
        },
        {
            name: "Docs: LLM Endpoint",
            url: "https://tatakaiapi.vercel.app/docs/llm",
            raw: true,
